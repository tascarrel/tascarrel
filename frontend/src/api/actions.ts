...
export type HostActions = {
  ...
  "repositories_PrepareSnapshot": { input: types.repositories.PrepareRepositorySnapshotAction; output: types.repositories.PrepareRepositorySnapshotOutput };
...
export type GuestActions = {
  ...
  "chats_GetUsageReport": { input: types.chats.GetChatUsageReportAction; output: types.chats.GetChatUsageReportOutput };
  ...
  "chats_SetCostCenter": { input: types.chats.SetChatCostCenterAction; output: types.chats.SetChatCostCenterOutput };
...
export type HostSubscriptions = {
  ...
  "hostOperations_Commands": { input: types.host_operations.HostCommandListChangedSubscription; output: types.host_operations.HostCommandListChangedEvent };
...
export type GuestSubscriptions = {
  ...
  "chats_UsageReport": { input: types.chats.ChatUsageReportSubscription; output: types.chats.ChatUsageReportEvent };
