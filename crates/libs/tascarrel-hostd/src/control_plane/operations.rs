//! Shared typed host-operation traits.
...
/// Executes one decoded action against the composed host state.
#[async_trait]
pub(crate) trait ExecuteAction: HostAction {
...
/// Opens one decoded subscription against the composed host state.
#[async_trait]
pub(crate) trait OpenSubscription: HostSubscription {
    ...
    /// Typed event source returned by the host service.
...
/// Receives typed events from one host subscription.
#[async_trait]
